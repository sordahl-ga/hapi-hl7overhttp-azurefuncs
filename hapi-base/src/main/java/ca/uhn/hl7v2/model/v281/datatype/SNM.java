...
public class SNM extends ca.uhn.hl7v2.model.primitive.ID {
    
    /**
     * @param theMessage message to which this Type belongs
     */
    public SNM(Message theMessage) {
        super(theMessage);
    }
     ...
     */
    public SNM(Message theMessage, int theTable) {
     ...
     * @param theTable HL7 table from which values are to be drawn 
     */
    public SNM(Message theMessage, Integer theTable) {
        super(theMessage, theTable);
    }
